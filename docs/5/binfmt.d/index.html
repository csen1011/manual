...
<p>binfmt.d - Configure additional binary formats for executables at boot</p>
</div></div><h1 id='synopsis'><a href='#synopsis'>SYNOPSIS</a></h1><div class='section' data-for='synopsis'><div data-more>
<p>/etc/binfmt.d/*.conf</p>
<p>/run/binfmt.d/*.conf</p>
<p>/usr/lib/binfmt.d/*.conf</p>
</div></div><h1 id='description'><a href='#description'>DESCRIPTION</a></h1><div class='section' data-for='description'><div data-more>
<p>At boot, <a href='/8/systemd-binfmt.service'>systemd-binfmt.service</a>(8) reads configuration files from the above directories to register in the kernel additional binary formats for executables.</p>
...
<p>Each file contains a list of binfmt_misc kernel binary format rules. Consult the kernels <strong>binfmt-misc.rst</strong>[1] documentation file for more information on registration of additional binary formats and how to write rules.</p>
<p>Empty lines and lines beginning with ; and # are ignored. Note that this means you may not use ; and # as delimiter in binary format rules.</p>
...
<p><a href='/1/systemd'>systemd</a>(1), <a href='/8/systemd-binfmt.service'>systemd-binfmt.service</a>(8), <a href='/1/systemd-delta'>systemd-delta</a>(1), <a href='/8/wine'>wine</a>(8)</p>
</div></div><h1 id='notes'><a href='#notes'>NOTES</a></h1><div data-for='notes' data-hide><div class='section' data-for='notes'><div data-more>
<ul>
<li><p>binfmt-misc.rst</p>
<p><a href="https://www.kernel.org/doc/html/latest/admin-guide/binfmt-misc.html">https://www.kernel.org/doc/html/latest/admin-guide/binfmt-misc.html</a></p></li>
</ul></div></div></div>
